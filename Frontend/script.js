 ...
 *
 * window.APP_API_URL can override this at runtime when needed.
 */
...
const configuredApiUrl =
    typeof window.APP_API_URL === "string"
        ? window.APP_API_URL.trim()
        : "";
...
const API_URL = (
    configuredApiUrl ||
    (isLocalDevelopment ? LOCAL_API_URL : PRODUCTION_API_URL)
).replace(/\/$/, "");

console.log("AI Interview Simulator Frontend v3.1.0");
console.log("Interview API:", API_URL);
...
/**
        ...
        if (
            ...
            console.error("Invalid /session/start response:", {
                apiUrl: API_URL,
            ...
            throw new Error(
                ...
                "Check the browser console for the API URL and response."
            );
